...
function spwp_connect_activate() {
    ...
    $t1 = $wpdb->prefix . 'spwp_plan_map';
    $t2 = $wpdb->prefix . 'spwp_api_log';
    dbDelta( "CREATE TABLE $t1 (id bigint(20) NOT NULL AUTO_INCREMENT,ce_product_id bigint(20) NOT NULL,ce_product_name varchar(255) NOT NULL DEFAULT '',wc_product_id bigint(20) NOT NULL DEFAULT 0,wc_product_name varchar(255) NOT NULL DEFAULT '',sync_direction varchar(20) NOT NULL DEFAULT 'ce_to_wp',status varchar(20) NOT NULL DEFAULT 'active',last_synced datetime DEFAULT NULL,created_at datetime NOT NULL,PRIMARY KEY (id),KEY ce_product_id (ce_product_id)) $charset_collate;" );
    dbDelta( "CREATE TABLE $t2 (id bigint(20) NOT NULL AUTO_INCREMENT,method varchar(10) NOT NULL,endpoint varchar(255) NOT NULL,status_code int(5),response_time float,error_message text,created_at datetime NOT NULL,PRIMARY KEY (id)) $charset_collate;" );
    flush_rewrite_rules();
}
register_activation_hook( __FILE__, 'spwp_connect_activate' );
function spwp_connect_deactivate() { flush_rewrite_rules(); }
